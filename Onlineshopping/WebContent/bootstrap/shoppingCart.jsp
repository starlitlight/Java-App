...
<body>
	...
	<div class="container" style="margin-top: 30px;">
		...
		<div class="row">
			...
			<div class="col-xs-9">
				<div class="row">
					<table class="table table-striped table-hover " action=>
						<thead>
							<tr>
								<th>Image</th>
								<th>Description</th>
						...
						<tbody>
							...
							<tr>
								...
								<td><img src="<%=request.getContextPath()%>/bootstrap/img/<%=product.getImage()%>"
							width="100%" alt="Something"></td>
								<td><%=product.getContext()%></td>
								<td><%=cart.getAmount()%></td>
								<td><%=product.getPrice() %></td>
								<td><%= cart.getAmount() * product.getPrice()%></td>
								<td><a href="<%=request.getContextPath() %>/DeleteCartServlet?cartId=<%=cart.getCartId()%>"> DELETE</a></td>
							</tr>
							<%} %>
						</tbody>
					</table>
