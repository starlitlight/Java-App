...
<body>
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container-fluid">
				...
				<div class="navbar-collapse collapse">
					...
					<ul class="nav navbar-nav navbar-right">
						<li><a
							href="<%=request.getContextPath()%>/bootstrap/admin.jsp"><%=username%></a></li>
					</ul>
					<% }else{ %>
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel"
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="<%=request.getContextPath()%>/bootstrap/img/1.jpg"
						alt="...">
				</div>
				<div class="item">
					<img src="<%=request.getContextPath()%>/bootstrap/img/2.jpg"
						alt="...">
				</div>
				<div class="item">
					<img src="<%=request.getContextPath()%>/bootstrap/img/3.jpg"
						alt="...">
				</div>
			</div>
	...
	<div class="container" style="margin-top: 30px;">
		...
		<div class="row">
			...
			<div class="col-xs-9"
				style="border-left: 1px solid #e2e2e2; height: 900px;">
				<div class="row">
					<%
					...
					<div class="col-xs-4" style="padding-right: 0;">
						<a
							href="<%=request.getContextPath()%>/FindProductByIdServlet?productId=<%=product.getProductId()%>"><img
							src="<%=request.getContextPath()%>/bootstrap/img/<%=product.getImage()%>"
							alt="category 1" height="200" width="250"></a>
						<h3><%=product.getProductName()%></h3>
						<p class="product_price"><%=product.getPrice()%>
							Kr
						</p>
						<a
							href="<%=request.getContextPath()%>/FindCartByproductIdServlet?productId=<%=product.getProductId()%>">Add
